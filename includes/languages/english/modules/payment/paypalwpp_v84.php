 ...
 * ------
 * Modified for NVP 84.0 interface - lat9 - Vinos de Frutas Tropicales
 */

  define('MODULE_PAYMENT_PAYPALWPP_V84_TEXT_ADMIN_TITLE_EC', 'PayPal Express Checkout (NVP 84.0)');
