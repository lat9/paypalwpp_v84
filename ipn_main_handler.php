...
//    zen_redirect(zen_href_link(FILENAME_TIME_OUT));
  ...
  $zco_notifier->notify('NOTIFY_IPN_MAIN_HANDLER_IS_EC_TXN');  //-20131230-lat9-paypalwpp_84-a
...
Processing...
   ...
   */
  $transactionHandled = false;  //-20131230-lat9-paypalwpp_84
  switch ($txn_type) {
    case ($_POST['txn_type'] == 'send_money'):
    case ($_POST['txn_type'] == 'merch_payment'):
    case ($_POST['txn_type'] == 'new_case'):
    case ($_POST['txn_type'] == 'masspay'):
//-bof-20131230-lat9-paypalwpp_84
      $zco_notifier->notify('NOTIFY_IPN_MAIN_HANDLER_TXN_TYPE_CHECK');
...
//-eof-20131230-lat9
    ...
    case 'express-checkout-cleared':
      ...
      break;
    default:
//-bof-20131230-lat9-paypalwpp_v84
      $zco_notifier->notify('NOTIFY_IPN_MAIN_HANDLER_TXN_TYPE_DEFAULT');
      if (!$transactionHandled) {
//-eof-20131230-lat9
